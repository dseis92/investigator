...
export default async function MasterChronologyPage({ params }: { params: Promise<{ matterId: string }> }) {
  ...
  return <DerivedReport title="Master Chronology" description="A single chronological view of events, evidence, statements, deadlines, and appointments recorded in the matter." matterName={matter.name} matterNumber={matter.matter_number} matterId={matterId} reportType="master-chronology" sections={sections} />
}
