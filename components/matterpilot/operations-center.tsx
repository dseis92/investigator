...
export function OperationsCenter({
  ...
  const [ruleOffset, setRuleOffset] = useState("3")
  const [ruleBusinessDays, setRuleBusinessDays] = useState(true)
  const [deadlineMatter, setDeadlineMatter] = useState(matters[0]?.id ?? "")
  ...
  const [timeRate, setTimeRate] = useState("250")
